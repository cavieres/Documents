-------------------------------------------------------------------------------
-- Anonymizer Data Base v1.1
-- Fecha: 2017-02-17 10:00hrs
-- Descripcion:
-- - Se eliminan los LOGS del Sistema
-- - Reempleza Datos de los Trabajadores:
-- 		- Codigos, Rut, Nombre, Direccion, Telefono, Correo.
-- - Modifica Jefes a Cargo por el primer Trabajador Activo que encuentra
-- - Remplaza Datos de la Empresa:
--		- Nombre, Rut, Duireccion, Correos, Telefono.
-- - Modifica Datos del Grupo Familiar:
--		- Nombre, Rut, Codigo.
-------------------------------------------------------------------------------
...
CREATE TABLE #Remplescodigo 
(
codigoremplesantiguo char(12) not null,
codigoremplesnuevo   char(12) not null,
nombreremplesantiguo char(60) not null,
nombreremplesnuevo   char(60) not null
 )
...
CREATE TABLE #RemplesRut (
codigorutantiguo char(12),
codigorutnuevo   char(12) not null
 )
